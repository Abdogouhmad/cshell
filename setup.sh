...
# Global constants
REPO_URL="https://github.com/Abdogouhmad/cshell"
BIN_PATH="/usr/bin/cshell"
...
install_cshell() {
    ...
    # Download the binary
    if ! sudo wget -q --show-progress -O "${BIN_PATH}" "${REPO_URL}/releases/latest/download/cshell"; then
